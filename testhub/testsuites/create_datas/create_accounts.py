...
class CreateUsers(TaskSet):
    ...
    def test_create_user(self):
        ...
        1. 注册新用户
         """
        user_filename = "".join([DATASETS_PRENAME,"_","fake_user.csv"])
    ...
    def test_create_group(self):
        ...
        2. 注册新用户组
         """
        group_filename = "".join([DATASETS_PRENAME,"_","fake_group.csv"])
    ...
    def test_create_role(self):
        ...
        3. 注册新role
         """
        role_filename = "".join([DATASETS_PRENAME,"_","fake_role.csv"])
